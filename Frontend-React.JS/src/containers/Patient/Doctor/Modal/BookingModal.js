...
class BookingModal extends Component {
    ...
    handleConfirmBooking = async (userId) => {
    ...
    render() {
        let { language, isOpenModal, closeBookingModal, dataTime, userInfo, reason } = this.props
        let doctorIdData = ''
        if (dataTime && !_.isEmpty(dataTime)) {
                ...
                <div className='booking-modal-content'>
                    ...
                    <div className='booking-modal-footer'>
                        <button className='btn btn-primary btn-booking-confirm'
                            onClick={() => this.handleConfirmBooking(userInfo.id)}
