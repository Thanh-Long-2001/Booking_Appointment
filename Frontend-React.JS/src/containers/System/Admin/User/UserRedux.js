...
class UserRedux extends Component {
    ...
    toggleAddUserForm = (prevState) => {
        let arrGenders = this.props.genderRedux
        let arrRoles = this.props.roleRedux
        let arrPositions = this.props.positionRedux
        if(this.state.showAddUserForm == false ) {
            this.setState({

                showAddUserForm: !prevState.showAddUserForm,
            })
        } else if(this.state.showAddUserForm == true && this.state.email !== ""){
    ...
    checkValidateInput = () => {
        let isValid = true
        let arrCheck = ['email', 'password', 'firstName', 'lastName', 'phoneNumber', 'address', 'birthday']
    ...
    render() {
        ...
        let {email, password, firstName, lastName, phoneNumber, birthday, address, gender, position, role, avatar} = this.state
                ...
                <div className="user-redux-body" >
                    <div className='container'>
                        <div className='row'>
                            ...
                            <button className='add-new-user' onClick={this.toggleAddUserForm}>Thêm người dùng mới</button>
                            </div>
