...
class ManageDoctor extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (prevProps.allDoctors2 !== this.props.allDoctors2) {
            let dataSelect = this.buildDataInputSelect(this.props.allDoctors2, 'USERS')
    ...
    render() {
        ...
        console.log(this.props.allDoctors2);
        return (
...
const mapStateToProps = state => {
    return {
        allDoctors2: state.admin.allDoctors2,
