...
class ManageSchedule extends Component {
  ...
  render() {
    ...
    this.state.selectedDoctor = userInfo;
    const currentDate = new Date();
    let minDate = new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate() + (1 - currentDate.getDay()));
      ...
      <div className="manage-schedule-container">
        ...
        <div className="container">
          <div className="column">
            <div className="col-5 form-group custom-title">
              <label>
            ...
            <label className="custom-label">
                <FormattedMessage id="manage-schedule.choose-hours" />
            </label>
