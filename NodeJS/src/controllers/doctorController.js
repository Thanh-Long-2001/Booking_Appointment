...
let getAllDoctors = async (req, res) => {
    ...
    try {
        let doctors = await doctorService.getAllDoctorsService(page)
...
let getAllDoctors2 = async (req, res) => {
    try {
        let doctors = await doctorService.getAllDoctorsService2()
        return res.status(200).json(doctors)
    } catch (e) {
        console.log(e)
        return res.status(200).json({
...
let getDoctorByName = async (req, res) => {
    try {
        let doctors = await doctorService.getDoctorByName(req.query.name)
        return res.status(200).json(doctors)
    } catch (e) {
        console.log(e)
        return res.status(200).json({
